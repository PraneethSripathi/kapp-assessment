...
interface CandidateDetail {
  ...
  practicalSubmission: {
    uploadedFile: string; uploadedAt: string; submittedAt: string;
              ...
              <>
                <div className="mb-6">
                  ...
                  <div className="flex items-center gap-3">
                    <a
                      href={practicalSubmission.uploadedFile.startsWith("/uploads/")
                        ? `/api/admin/download?path=${encodeURIComponent(practicalSubmission.uploadedFile)}`
                        : practicalSubmission.uploadedFile
                      }
                    ...
                    <span className="text-sm text-gray-500">
                      Submitted: {practicalSubmission.submittedAt
                        ? new Date(practicalSubmission.submittedAt).toLocaleString()
                        : "Not submitted"}
                    </span>
                  </div>
                </div>
